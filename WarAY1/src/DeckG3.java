...
public class DeckG3
{
	...
	public DeckG3( )
	{
		...
		CardG3 card; // temporary card for rank and suit assignment
		cards = new CardG3[ 52 ];// an array of 52 cards to create a full deck
	...
	public DeckG3( int numberOfCards ) 
	{
		int i; // LCV
		...
		CardG3 card; // temporary card for rank and suit assignment
		cards = new CardG3[ 52 ];// an array of cards. Number of cards equates to sizeOfQueue
	...
	public void organizer( ) 
	{
		...
		CardG3 tempCard = new CardG3 ( 0, 0 );//temporary card for data member swap
	...
	{
		int j;//index reference variable
		CardG3 tempCard = new CardG3 ( 0, 0 );//a temporary card for swapping
		 ...
		 * @return: None
		 */
	public static void shuffleAny( DeckG3 deck )
	{
		int j;//index reference variable
		CardG3 tempCard = new CardG3 ( 0, 0 );// temporary card to swap with
	 ...
	 */
	public DeckG3 getSubDeck( int start, int end )
	{
		...
		numCards = end - ( start );
		DeckG3 subDeck = new DeckG3 ( numCards );
		for ( i = start; i < end; i++ )
		{
...
//	}//end of addCard
	 ...
	 */
		...
		public CardG3[ ] getCards( )
	{
		return cards;
	}

	public void setCards( CardG3[ ] cards )
	{
		this.cards = cards;
	}
